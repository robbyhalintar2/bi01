...
# USERNAME
rm -f /usr/bin/user
username=$(curl -sS https://raw.githubusercontent.com/robbyhalintar2/bi01/main/Aktivasi | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
# validity
rm -f /usr/bin/e
today=`date -d "0 days" +"%Y-%m-%d"`
valid=$(curl -sS https://raw.githubusercontent.com/robbyhalintar2/bi01/main/Aktivasi | grep $MYIP | awk '{print $3}')
...
echo -e " $BLUE│$NC$r • $NC$WHITE Whatsapp :$NC $GREEN -$NC"
echo -e " $BLUE│$NC$r • $NC$WHITE Telegram :$NC $GREEN cx$NC"
echo -e " $BLUE╰──────────────────────────────────────────────────────────╯${NC}"
sleep 3
exit 1
else
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/robbyhalintar2/bi01/master/"
...
print_install "Membuat direktori xray"
    mkdir -p /etc/xray
    wget https://raw.githubusercontent.com/robbyhalintar2/bi01/main/Aktivasi -O /etc/xray/premium
...
function restart_system() {
    USRSC=$(curl -sS https://raw.githubusercontent.com/robbyhalintar2/bi01/main/Aktivasi | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/robbyhalintar2/bi01/main/Aktivasi | grep $MYIP | awk '{print $3}')
    DATEVPS=$(date +'%d/%m/%Y')
...
"'&reply_markup={"inline_keyboard":[[{"text":"Website","url":"https://vpnz.my.id"}]]}' 
